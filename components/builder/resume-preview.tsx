    ...
    <Card className="w-full max-w-2xl mx-auto">
      ...
      <CardContent className="space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-lg text-muted-foreground">{personalDetails?.title || "Professional Title"}</p>
        ...
        {/* Empty State */}
        {!personalDetails?.fullName && !summary && (!workExperience || workExperience.length === 0) && (
